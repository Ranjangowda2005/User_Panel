...
it("formu gönderince addUser fonksiyonu doğru parametrelerle çağrılmallı", async () => {
  ...
  expect(mock).toHaveBeenCalledWith({
    // burda toHaveBeenCalledWith kullanıyoruz çünkü fonksiyonun çağrılıp çağrılmadığını değil
